...
export default function Carta6() {
    ...
    return (
        <div ref={ref} className="bg-gradient-to-br from-blue-500/80 to-green-500/80 rounded-[2rem] pt-14 pb-20 px-8 md:py-[90px] md:px-[80px] relative overflow-hidden shadow-xl">
            <h3 className="text-[40px]  md:text-[50px] font-bold mb-6 leading-none text-white">
